            ...
            <Wrapper>
                <div className="flex flex-col items-center justify-center px-2 md:px-0 h-full">
                    ...
                    <Container delay={0.1} className="flex grow">
                        <h2 className="text-3xl lg:text-4xl lg:text-center font-semibold tracking-tight mt-4">
                            How Verve got Started
                        </h2>
                    </Container>
                    <Container delay={0.3} className="max-w-2xl mx-auto">
                        <p className="text-base lg:text-lg lg:text-center font-normal text-muted-foreground mt-4">
